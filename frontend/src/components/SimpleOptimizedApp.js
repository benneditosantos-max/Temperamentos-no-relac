...
export const SimpleOptimizedTemperamentApp = () => {
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-3 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
                      ...
                      <div>
                        <h4 className="font-bold text-gray-800">Na intimidade</h4>
                        <p className="text-gray-600 text-sm">Passional e iniciativo, valoriza momentos intensos</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
                      <span className="text-2xl">⚡</span>
                      <div>
                        <h4 className="font-bold text-gray-800">Resolução de conflitos</h4>
                        <p className="text-gray-600 text-sm">Prefere enfrentar problemas de frente e buscar soluções práticas</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-3 p-4 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-lg border border-emerald-200">
                      <Lightbulb className="h-5 w-5 text-emerald-500 flex-shrink-0 mt-1" />
                      <div>
                        <h4 className="font-bold text-gray-800">Valorize processos</h4>
                        <p className="text-gray-600 text-sm">Nem tudo precisa ser resolvido imediatamente</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-4 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-lg border border-emerald-200">
                      <Lightbulb className="h-5 w-5 text-emerald-500 flex-shrink-0 mt-1" />
                      <div>
                        <h4 className="font-bold text-gray-800">Celebre pequenos momentos</h4>
                        <p className="text-gray-600 text-sm">Encontre beleza na rotina e nos detalhes do relacionamento</p>
                      </div>
                    </div>
                  </div>
                </div>
...
export default SimpleOptimizedTemperamentApp;